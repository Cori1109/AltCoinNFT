          ...
          <Row style={{ justifyContent: "space-between" }}>
            ...
            >
              <div className="text-white">
                <Image
                  src="cross_chain_yield_optimizer.png"
                  className="w-100"
                />
              </div>
            </Col>
            <Col lg={6} md={12}>
              <Row>
                <Card style={{ paddingLeft: "2rem", paddingTop: "2rem" }}>
                  <h5>HOW IT WORKS</h5>
                  <p></p>
                  ...
                  <p className="textAlignLeft">
                    Every secondary NFT sale incurs a 10% royalty, which is
                    added to the staking pool. This means your rewards compound
                    with every 3rd party NFT sale in the future.
                  </p>
